...
export class AgentService {
  constructor() {
    // Use endpoint instead of connection string
    const endpoint = process.env.AZURE_AI_PROJECT_ENDPOINT || "<YOUR_PROJECT_ENDPOINT>";
    ...
    this.agentId = process.env.AZURE_AGENT_ID || "<YOUR_AGENT_ID>";
  }
